...
export const updatePackageSchema = z.object({
  name: z.string({ message: 'Bạn phải nhập tên gói' }).trim().min(1, 'Bạn phải nhập tối thiểu 1 kí tự').max(200, 'Tối đa 200 kí tự'),
  durationValue: z
...
export type TypeUpdatePackageSchema = z.infer<typeof updatePackageSchema>;
